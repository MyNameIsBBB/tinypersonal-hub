...
export const toolCatalog: Record<ToolName, { description: string; keywords: string[] }> = {
  ...
  searchNotes: { description: "List all notes or search by text, tag, or folder.", keywords: ["note", "notes", "all notes", "find note", "ค้นโน้ต", "โน้ต", "โน๊ต", "ทุกโน้ต", "ทุกโน๊ต"] },
