...
export const toolCatalog: Record<ToolName, { description: string; keywords: string[] }> = {
  ...
  delegateCodingTask: { description: "Run a local Codex worker for a repository task: inspect, summarize, change code, build, and optionally push a branch.", keywords: ["code", "coding", "codex", "worker", "delegate", "inspect repository", "inspect project", "summarize system", "git status", "git branch", "implement", "refactor", "fix code", "สั่ง worker", "สั่งงาน worker", "สั่ง codex", "ตรวจระบบ", "ตรวจโปรเจค", "ตรวจ repo", "inspect", "สรุประบบ", "สรุปโปรเจค", "แก้โค้ด", "เขียนโค้ด", "เช็ก git"] },
