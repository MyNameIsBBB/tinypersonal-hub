...
export const capabilityEvalCases: AgentEvalCase[] = [
  ...
  {
    id: "cap-coding-delegate",
    prompt: "ส่งงานตรวจ git status ให้ Codex",
    expectedIntent: "coding.delegate",
    expectedTools: ["delegateCodingTask"],
    expectedCalls: [{
      toolName: "delegateCodingTask",
      expectedArguments: { instruction: "ตรวจ git status", readOnly: true },
    }],
  },
];
...
export const capabilityEvalObservations: AgentEvalObservation[] = [
  ...
  {
    caseId: "cap-coding-delegate", actualIntent: "coding.delegate", actualTools: ["delegateCodingTask"],
    actualCalls: [{ toolName: "delegateCodingTask", arguments: { instruction: "ตรวจ git status", readOnly: true }, confirmationRequested: true, executionSucceeded: true }],
  },
];
