...
export default function LoginPage() {
  ...
  return <main className="login-page"><section className="login-card">
    <Image src="/tinypersonal-logo-192.png" width={76} height={76} alt="TinyPersonal" priority />
    <p className="eyebrow">Private workspace</p><h1>TinyPersonal Hub</h1><p>เข้าสู่พื้นที่ส่วนตัวเพื่อเปิด Schedule, Notes, Vault และ AI</p>
