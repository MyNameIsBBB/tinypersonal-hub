...
export default function setup() {
  ...
  // Start with an empty file so the Windows schema engine can open the database.
  ...
  return () => {
    ...
    if (dirname(directory) !== resolve(tmpdir()) || !basename(directory).startsWith("tinypersonal-vitest-")) {
